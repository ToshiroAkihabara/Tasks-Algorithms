...
class TestVectorNumpy:
    def test_vector_sum(self, vec_num: VectorNumpy) -> None:
        assert (vec_num.vectors_sum(np.array([2, 3]), np.array([5, 8])) == np.array([7, 11])).all()

    def test_vector_sub(self, vec_num: VectorNumpy) -> None:
        assert (vec_num.vectors_sub(np.array([2, 3]), np.array([5, 8])) == np.array([-3, -5])).all()

    def test_vector_mult(self, vec_num: VectorNumpy) -> None:
        assert (vec_num.vectors_mult(np.array([2, 3]), np.array([5, 8])) == np.array([10, 24])).all()

    def test_vector_div(self, vec_num: VectorNumpy) -> None:
        assert (vec_num.vectors_div(np.array([2, 40]), np.array([2, 8])) == np.array([1, 5])).all()
